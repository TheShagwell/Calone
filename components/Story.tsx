  ...
  return (
    <>
        <div className='max-container padding-container my-28'>
            ...
            <p className='w-[646px] text-offWhite-10 mb-6 regular-16'>We believe everyone's stories can and should be heard, so we're giving creators around the world, from first-time podcasters to pros a powerful platform to share their stories.</p>
